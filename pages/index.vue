<template>
    <section>
        <h1 class="text-5xl font-bold mt-20">👋🏻 Hello, I'm Grégory Valsaint!</h1>
        <p class="text-base text-gray-900 p-2 italic">Vue.js Developer Fullstack</p>
    </section>
    <section class="flex flex-col md:flex-row">
        ...
        <img src="https://fly.storage.tigris.dev/sticker-bucket/prediction-94259-sticker.png" class="w-1/2 md:max-w-sm p-8 mx-auto" />
    </section>
</template>